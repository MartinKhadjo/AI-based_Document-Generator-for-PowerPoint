...
- the user-facing PowerPoint automation workflow;
- AI-assisted document generation capabilities;
- interaction between the Office/PowerPoint interface and AI functionality;
...
- private prompts or model configuration;
- API keys or `.env` files;
- internal deployment details;
- confidential institutional or customer data.
